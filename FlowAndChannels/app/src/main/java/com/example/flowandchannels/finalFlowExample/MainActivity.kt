...
class MainActivity : AppCompatActivity() {
    ...
    private var screenState = MutableStateFlow<ScreenState>(ScreenState.Initial)
    ...
    init {
        ...
        requests.receiveAsFlow()
            ...
            .map {
                ...
                screenState.emit(ScreenState.Error("Connection error"))
                true
            }.catch {
                Log.d(("MY"), it.toString())
            }
        ...
        screenState.onEach {
            when (it) {
                ...
                is ScreenState.Error -> {
                    searchResult.text = it.errorMessage
                    searchButton.isEnabled = true
                }
            }
        }.launchIn(scope)
